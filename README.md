...
src/pettriage/
  ...
  compute/       비-RAG 계산 노드 (에너지·독성 임계치)
    rules.py       규칙 테이블 조회 — 이 표를 읽는 유일한 경로 (D-16)
  ...
  privacy/       개인정보 제거 (EXIF·얼굴·필드)            (D-36 · D-43)
...
data/            🔴 대장 + **사실 표**만 커밋 (D-37). 원문은 커밋 금지 (D-29)
...
| 4 | [`06_결정기록`](docs/06_설계결정기록.md) | **결정 43건**의 맥락·대안·트레이드오프 |
