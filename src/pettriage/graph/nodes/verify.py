...
설계 근거: 02 §2 · §9 · D-05 · 05 §4 (④)
    ...
    **판정에 따른 조치는 코드가 한다** — 재검색 1회 · 거절.
    ...
    🔴 **조치 「문장 제거」는 폐기됐다 (04b §3.4 · 02 §9).** 이 머리말에 오래
    *"문장 제거 · 재검색 1회 · 거절"* 이라고 적혀 있었고, 폐기 사실은 문서에만
    있어서 **2026-08-08 에 실제로 구현돼 들어왔다가 되돌렸다.** 그래서 사유를
    문서가 아니라 여기 적는다.
...
def verify_grounding(state: GraphState) -> GraphState:
    ...
    # 🔴 여기서 근거있음만 남겨 `draft` 를 다시 쓰지 않는다 (2026-08-08 되돌림).
